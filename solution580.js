...
// Output is a number.
    // doTest('rr', 4);
    // doTest('rr rrr', 8);
    // doTest('rr rrr rrr rr', 16);
    // doTest('rrrrrrrrrrrrrrrrrr   rr r', 34);
// Split with white space then join and use length and multiply by 2. If modules divided by 5 is greater then 0