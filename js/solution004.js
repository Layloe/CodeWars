...
function span(arr, predicate) {
    //   P arry of things, predict call back function
    //   R two arrys, first bireng elelments until the predicate returns false, second bieng
    //   E
    //   P
      const pass = [];
