...
function modifyMultiply (str,loc,num) {
  const findRepeat = str.split(' ')[loc] + '-' 
  return findRepeat.repeat(num).slice(0,-1)
  //Code here
} 
console.log(modifyMultiply("This is a string", 3, 5))
// Input has three parameters. First is a string of words, second is an integer, and third is also an integer.
// Output is the location of the word repeated x amount of times with a '-'.
...
// Split map and use index to find word the repeat num param.