...
// Output is a string that contains the original argument with all odd length words having an extra letter. It will also remove all punctuation.
    // Test.assertEquals(evenator('f'),'ff','');
    // Test.assertEquals(evenator('I got a hole in 1!'),'II gott aa hole in 11','');
    // Test.assertEquals(evenator('evenn'),'evennn','')
    // Test.assertEquals(evenator('even odd!'),'even oddd','');
    // Test.assertEquals(evenator('eve odd.'),'evee oddd','');
