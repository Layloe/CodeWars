...
const discountNum = normPrice / discount + '%'
return discountNum
}
console.log(dutyFree(12, 50, 1000))
// Input has three parameters and are all numbers.
// Output is a number.
...
// Divide first param by the second. On the second parameter concat "." and divide. Then take that total and divide it into last parameter to get the total bottles.