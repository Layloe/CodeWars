...
// The input array will always be valid and formatted as in the example above.
 ...
 // Input is a array of objects.
 // Output is an object containing languages as a key and value as a count.
 // Example above.
 // Create a var that contains empty object that will hold results. Use a for of loop to loop through the arr and extract languages, then use conditional to check if lang is empty object if not add if true increase count by 1.