// our boss decided to save money by purchasing some cut-rate optical character recognition software for scanning in the text of old novels to your database. At first it seems to capture words okay, but you quickly notice that it throws in a lot of numbers at random places in the text.
...
//Parameters: A string with that's a mix of letters and nums

//Return: A string that that removes nums while keeping spacing and special characters ~#$%^&!@*():;"'.,? all intact.
...
//Psuedocode: Filter out all these nums '123456789'out of the string
